...
import {HomeWelcomeWidget} from "../home/widgets/home.welcome.widget.js";
import {imagesVersion} from "../app.js";
import {HomeLatestAdsWidget} from "../home/widgets/home.latest.ads.widget.js";
import {MatchManager} from "../riot/match.manager.js";
import {HomeMatchHistoryWidget} from "../home/widgets/home.match.history.widget.js";
import {HomeTipsWidget} from "../home/widgets/home.tips.widget.js";
import {HomePopularPlayersWidget} from "../home/widgets/home.popular.players.widget.js";
...
export class HomeService {
    ...
    async getHomeFeedTree(userId: number): Promise<Array<HomeWidget>> {
        const widgets = new Array<HomeWidget>();
        ...
        // Add Welcome Widget
        const welcomeWidget: HomeWelcomeWidget = {
            type: "welcome_widget",
        ...
        // Add Latest News
        const latestNewsWidget: HomeLatestAdsWidget = {
            type: "latest_news",
            items: this.getFirstPageLatestNewsWidget()
        };
        widgets.push(latestNewsWidget);

        // Add Most Popular Streamers and Players Widget
        const popularFirstPage: HomePopularPlayersWidget = {
            type: "players",
        ...
        // Add Last Match
        const matchHistoryWidget: HomeMatchHistoryWidget = {
        ...
        // Add Latest News
        const secondLatestNewsWidget: HomeLatestAdsWidget = {
            type: "latest_news",
        ...
        // Add Most Popular Streamers and Players Widget
        const popularSecondPage: HomePopularPlayersWidget = {
            type: "players",
            items: this.getSecondPageMostPopularPlayersList()
        };
        widgets.push(popularSecondPage);

        // Add Home Tips Widget
        const tips: HomeTipsWidget = {
            type: "tips",
    ...
    private getSecondPageMostPopularPlayersList(): any {
        return [
            {
                "game_key": "lol",
    ...
    private getFirstPageMostPopularPlayersList(): any {
        return [
            {
                "game_key": "lol",
                "game_name": "League of Legends",
    ...
    private getFirstPageLatestNewsWidget(): any {
        return [
            {
                "game_key": "lol",
                "game_name": "League of Legends",
    ...
    private getSecondPageLatestNewsWidget(): any {
        return [
            {
                "game_key": "valorant",
                "game_name": "Valorant",
